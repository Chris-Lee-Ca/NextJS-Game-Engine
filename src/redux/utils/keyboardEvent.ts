...
import {
    clearPlayerKeyboardEvent,
    setPlayerKeyboardEvent,
} from "../features/playerSlice";
import { AppDispatch } from "../store";

export const keyBoardEventHandler =
    (keyboardEvent: KeyboardEventType, key: string) =>
    (dispatch: AppDispatch) => {
        const updateMainCharacterPosition = (direction: Direction) =>
            dispatch(setMainCharacterPosition(direction));
